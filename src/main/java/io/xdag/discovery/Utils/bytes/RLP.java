...
import io.xdag.discovery.Utils.bytes.uint.BytesValueRLPInput;
import io.xdag.discovery.Utils.bytes.uint.RLPException;

import java.util.function.Consumer;

import static io.xdag.discovery.Utils.bytes.RLPDecodingHelpers.extractSize;
import static io.xdag.discovery.Utils.bytes.RLPEncodingHelpers.*;
