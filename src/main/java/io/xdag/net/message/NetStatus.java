...
public class NetStatus {
    ...
    //用于记录remote node的
    public NetStatus(BigInteger maxdifficulty,long totalnblocks,long totalnmain,int totalnhosts,long maintime){
    ...
    @Override public String toString(){
        return "NetStatus:[ total block size:"+this.totalnblocks+",total mainblock size:"+this.totalnmain
                +",max diff:"+this.maxdifficulty.toString(16)+" ]";
    }
