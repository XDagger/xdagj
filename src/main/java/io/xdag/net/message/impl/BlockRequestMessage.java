...
public class BlockRequestMessage extends AbstractMessage {
    ...
    public String toString() {
        ...
        return "[" + this.getCommand().name() + " starttime="
                + starttime + " endtime=" + this.endtime +" hash="+Hex.toHexString(hash) +" netstatus="+netStatus;
    }
    ...
    @Override public void encode(){
        ...
        //TODO：后续根据ip替换
        String tmp = "04000000040000003ef47801000000007f000001611e7f000001b8227f000001"+
                "5f767f000001d49d";
