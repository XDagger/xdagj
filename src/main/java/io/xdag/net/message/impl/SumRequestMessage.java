...
public class SumRequestMessage extends AbstractMessage {
    public SumRequestMessage(long starttime, long endtime,NetStatus netStatus) {
        super(SUMS_REQUEST, starttime, endtime, BytesUtils.bytesToLong(BytesUtils.generateRandomBytes(),0,true), netStatus);
        updateCrc();
    }
    ...
    public String toString() {
        ...
        return "[" + this.getCommand().name() + " starttime="
                + starttime + " endtime=" + this.endtime + " netstatus="+netStatus;
    }
