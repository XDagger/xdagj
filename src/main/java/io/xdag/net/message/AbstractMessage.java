...
public abstract class AbstractMessage extends Message {
    ...
    public AbstractMessage(XdagMessageCodes type,long starttime,long endtime,long random,NetStatus netStatus){
        parsed = true;
    ...
    public void encode(){
        ...
        //TODO：后续根据ip替换
        String tmp = "04000000040000003ef4780100000000" +
                "7f000001611e7f000001b8227f0000015f767f000001d49d";
...
//        byte[] iplist = netDB.encode(netDB.getActiveIP());
        ...
        // field 0 and field1
        byte[] first = BytesUtils.merge(BytesUtils.longToBytes(transportheader,true),BytesUtils.longToBytes(type,true),BytesUtils.longToBytes(starttime,true),
