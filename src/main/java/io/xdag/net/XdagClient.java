...
//    }
    ...
    public void connect(String host, int port,XdagChannelInitializer xdagChannelInitializer) {
        try {
            ...
            if (e instanceof IOException) {
                logger.debug("XdagClient: Can't connect to " + host + ":" + port + " (" + e.getMessage() + ")");
    ...
    public ChannelFuture connectAsync(String host, int port, XdagChannelInitializer xdagChannelInitializer) {
