...
public class PubSub {
   ...
   * @param eventClss the event classes to be subscribed.
   */
  @SafeVarargs
   ...
   *
   * @param subscriber the subscriber.
   * @param event the event to be unsubscribed.
   ...
   *
   * @throws UnreachableException this method should only be called for once, otherwise an exception
   *     will be thrown.
   */
  ...
  /** This thread will be continuously polling for new events until PubSub is stopped. */
