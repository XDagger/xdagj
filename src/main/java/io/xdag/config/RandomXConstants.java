...
public class RandomXConstants {
    ...
    public static long SEEDHASH_EPOCH_TESTNET_BLOCKS = 16;
    public static long SEEDHASH_EPOCH_TESTNET_LAG = 4;

    public static final long RANDOMX_FORK_HEIGHT = 1540096;
    public static long RANDOMX_TESTNET_FORK_HEIGHT = 32;// 196288
