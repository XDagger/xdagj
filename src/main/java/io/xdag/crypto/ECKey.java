...
public class ECKey implements Serializable {
    ...
    private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
        if (priv == null) {
            ...
            try {
                return ECKeyFactory
                    .getInstance(XdagProvider.getInstance())
    ...
    public String toStringWithPrivate() {
        ...
        if (privKey != null && privKey instanceof BCECPrivateKey) {
            b.append(" priv:").append(BytesUtils.toHexString(((BCECPrivateKey) privKey).getD().toByteArray()));
        }
        return b.toString();
    }
