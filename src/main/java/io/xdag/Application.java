...
public class Application {
	public static void main(String[] args) throws IOException {
		...
		log.info(
				...
				config.getNodeIp(), config.getNodePort(), config.getPoolIp(), config.getPoolPort(),
				config.getGlobalMinerLimit(), config.getMaxConnectPerIp(), config.getMaxMinerPerAccount(),
				config.getPoolRation(), config.getRewardRation(), config.getDirectRation(), config.getFundRation());
