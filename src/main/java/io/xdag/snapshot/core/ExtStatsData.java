...
public class ExtStatsData {
    ...
    public ExtStatsData(List<BigInteger> totalHashrate, List<BigInteger> ourHashrate, long hashrateLastTime,
            long nnoref, long nextra, long nhashes, double hashrateS, int nwaitSync, int cacheSize, int cacheUsage,
            double cacheHitRate, int useOrphanHashTable) {
    ...
    public static ExtStatsData parse(Bytes data) {
        ...
        return new ExtStatsData(totalHashrate, ourHashrate, hashrateLastTime, nnoref, nextra, nhashes, hashrateS,
                nwaitSync,
