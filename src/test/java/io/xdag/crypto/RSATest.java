...
public class RSATest {
  ...
  public void test() throws Exception {
    ...
    String encode =
        RSAUtils.publicEncrypt(data, RSAUtils.getPublicKey(keyPairMap.get("publicKey")));

    System.out.println("-----encrypt result----\n" + encode);
    // 1.use private key decrypt
    String decodeResult =
        RSAUtils.privateDecrypt(encode, RSAUtils.getPrivateKey(keyPairMap.get("privateKey")));
