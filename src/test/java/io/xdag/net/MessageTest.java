...
//    0400000004000000 3ef4780100000000  7f000001 611e 7f000001 b822 7f000001" 7f000001 611e7f00 0001b822 7f000001 net dbsend修改
    //ip        port
...
//        System.out.println(Hex.toHexString(uncryptData));
        ...
        System.out.println("=====================================sum reply message========================================");

        printMessage(sumReplyMessage);
        System.out.println("=====================================block request message========================================");

        printMessage(blockRequestMessage);
        System.out.println("=====================================blocks request message========================================");
        printMessage(blocksRequestMessage);

        System.out.println("=====================================Test generate message========================================");
        ...
        SumReplyMessage sumReplyMessage1 = new SumReplyMessage(current,sumRequestMessage1.getRandom(),netStatus,new byte[256]);
