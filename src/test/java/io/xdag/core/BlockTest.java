...
public class BlockTest {
    ...
    public void TestStore(){
        ...
        System.out.println("=====================================get block from store raw========================================");
        ...
        System.out.println("=====================================verify block sig========================================");
        ...
        System.out.println("=====================================get block from store info========================================");
        ...
        System.out.println("=====================================get blocks from store========================================");
        List<Block> blocks = blockStore.getBlocksByTime(txfirst.getTimestamp());
        for (Block block:blocks){
            System.out.println("=====================================each block from store========================================");
    ...
    public void TestAddressBlock(){
        ...
        System.out.println("=====================================First Account Raw========================================");
        ...
        if (ans == null|| ans.size() ==0){
            ...
            for (Address key:ans.keySet()){
                ...
                System.out.println("Send Amount:"+key.getAmount()+" hashlow:"+Hex.toHexString(key.getHashLow())+" type:"+key.getType());
