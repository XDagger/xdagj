...
# default JVM options
JAVA_OPTS="--add-opens java.base/java.nio=ALL-UNNAMED --add-opens java.base/sun.nio.ch=ALL-UNNAMED -server -Xms1g -Xmx1g -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=./heapdump -Xlog:gc*,gc+heap=trace,gc+age=trace,safepoint:file=./xdag-gc-%t.log:time,level,tid,tags:filecount=16,filesize=1m"
